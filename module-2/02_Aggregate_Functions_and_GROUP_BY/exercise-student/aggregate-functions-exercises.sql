...
SELECT round(gnp * 1000000 / population, 2) AS per_capita_gnp FROM country WHERE population != 0 ORDER BY per_capita_gnp DESC;
...
SELECT MAX(population) FROM country WHERE population IS NOT NULL;

-- 8. The maximum population of all cities in the world.
-- (largest city population in world: 10500000)
SELECT MAX(population) FROM city WHERE population IS NOT NULL;
...
SELECT round(AVG(population)::decimal, 4) FROM city WHERE countrycode = 'USA';

-- 12. The average population of cities in China.
-- (average city population in China: 484720.6997 approx.)
SELECT round(AVG(population)::decimal, 4) FROM city WHERE countrycode = 'CHN';
...
SELECT round((population / surfacearea)::decimal, 4) AS population_density FROM country ORDER BY population_density DESC LIMIT 1;

-- 15. The population density and life expectancy of the top ten countries with the 
-- highest life expectancies in descending order. 
-- (highest life expectancies in world: 83.5, 166.6666, "Andorra")
SELECT lifeexpectancy, round((population / surfacearea)::decimal, 4), name FROM country WHERE lifeexpectancy IS NOT NULL ORDER BY lifeexpectancy DESC LIMIT 10;
