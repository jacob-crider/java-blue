...
public class JdbcPersonDAOIntegrationTest {
    ...
    /*
        ...
        4) Disconnect form the database when the class is destroyed
     */
    ...
    public void get_person_by_id() {
        /*
            1) Arrange(Setup): Insert data to select (person row)
            2) Act (Test): Select the person by id using the DAO
            3) Assert (Verify): Compare the person returned from SELECT is the one we inserted
         */
    ...
    public void update_person() {
         ...
         */
        // Arrange - Insert person into the database
    ...
    // wrote method to insert multiple people, had to write here outside of the DAO to test properly
