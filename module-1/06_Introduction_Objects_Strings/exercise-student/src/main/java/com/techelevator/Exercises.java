...
public class Exercises {
	...
	public String helloName(String name) {
		...
		String helloString = "Hello " + newStr + "!";
	...
	public String makeOutWord(String out, String word) {
		...
		// How to get first 2 characters of out
		String firstTwoCharacters = out.substring(0, 2);
		// How to get last 2 characters of out
		String lastTwoCharacters = out.substring(2);
		// How to put everything together w/ first then word then last
		newWord = firstTwoCharacters + word + lastTwoCharacters;
	...
	public String extraEnd(String str) {
		...
		String lastTwoCharacters = str.substring(lengthOfString - 2);
	...
	public String middleTwo(String str) {
		int middleOfString = str.length() / 2 - 1;
		return str.substring(middleOfString, middleOfString + 2);
	}
	...
	public String middleThree(String str) {
		...
		return str.substring(lengthOfString - 1, lengthOfString + 2);
	}
	...
	public int last2(String str) {
		...
		for (int i = 0; i < str.length() - 2; i++) {
			...
			if (subString.equals(endOfString)) {
				countOfCharacters++;
			}
		}
	...
	public String stringX(String str) {
		...
		String newStr = str.substring(1, strLength - 1);
