...
public class Lecture {
    ...
    */
    ...
    /*
    11. Write an if statement that returns "Fizz" if the parameter is divisible 3 and returns an empty String for anything else.
    */
    public String returnFizzIfThree(int number) {
        // number is 3 is true then return "Fizz"
        // else return ""
        if (number == 3) {
            return "Fizz";
        }
